<%@ Page Title="" Language="C#" MasterPageFile="~/SiteCommon.Master" AutoEventWireup="true" CodeBehind="friendlyAgriculture.aspx.cs" Inherits="QualityFood.friendlyAgriculture" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="banner" style="background: url(images/banner5.jpg) center;">
        <h2>友善生態農業</h2>
        <nav>
            <a href="index.htm">Home<span>〉</span></a>
            <a>友善生態農業</a>
        </nav>
    </div>
    <!--banner-->
    <div id="agriculture">
            ...
            <section class="selectArea"> <!--上線None-->
        ...
        <section class="agricultureList">
            <ul id="container_li" class="container-fluid" runat="server">
            </ul>
        </section>
    </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" runat="server">
    <script type="text/javascript">
        ...
        function pagedata(pnum) {
            ...
            $.ajax({
                type: 'POST',
                url: 'friendlyAgriculture.aspx?page=' + pages + '&Type=' + $('#hselect1').val() + '&Area=' + $('#hselect2').val(),
                dataType: "text",
